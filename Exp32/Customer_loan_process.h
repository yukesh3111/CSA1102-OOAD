...
#ifndef CUSTOMER_LOAN_PROCESS_H
#define CUSTOMER_LOAN_PROCESS_H

#include <string>

/**
  * class Customer_loan_process
  * 
  */
...
public:
   ...
   * Empty Constructor
   */
  Customer_loan_process ();

  /**
   * Empty Destructor
   */
  virtual ~Customer_loan_process ();
